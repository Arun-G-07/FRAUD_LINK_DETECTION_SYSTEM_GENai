...
os.environ["GOOGLE_API_KEY"] = "AIzaSyBSIK2bwiVHzmhBpcy7XguwmblmJnC3erQ"
...
@app.route('/')
def home():
    return render_template("index.html", template_folder = "/home/arun/ZERO/MYWORK/REAL_TIME_FRAUDLINK_DETECTION _SYSTEM/templates" )
